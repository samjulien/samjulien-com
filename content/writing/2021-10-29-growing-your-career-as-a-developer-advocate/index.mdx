...
For the dev advocate, a career in DevRel is an _arbitrage_ opportunity. Here's a definition of arbitrage paraphrased from [Investopedia](https://www.investopedia.com/terms/a/arbitrage.asp#:~:text=Arbitrage%20is%20the%20simultaneous%20purchase,in%20the%20asset's%20listed%20price.&text=Arbitrage%20exists%20as%20a%20result,those%20inefficiencies%20and%20resolves%20them.):
