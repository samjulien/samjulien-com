...
I have palettes set up for Work, Business, and Personal. For example, I can hit an Option-Control-Command-B to bring up a bunch of links related to my site business. Keyboard Maestro highlights the letters in blue, and I can start typing S and then T to launch the "Stacking the Bricks" podcast.
