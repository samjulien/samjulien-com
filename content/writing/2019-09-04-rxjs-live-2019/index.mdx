...
Thanks for joining Mike Ryan and I at [RxJS Live 2019](https://www.rxjs.live/)! We hope you learned a lot about the `groupBy` operator, as well as when to use `exhaustMap`, `switchMap`, and `concatMap`!
