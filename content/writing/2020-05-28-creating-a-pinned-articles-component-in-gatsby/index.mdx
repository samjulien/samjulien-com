...
If you like these Gatsby tips, hop on to my newsletter below. If you're new to Gatsby and want to get started from scratch, check out my Thinkster course [Up and Running with Gatsby](https://thinkster.io/tutorials/up-and-running-with-gatsby-intro).
