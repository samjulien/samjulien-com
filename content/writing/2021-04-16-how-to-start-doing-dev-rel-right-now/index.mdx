...
In this article, I’m going to teach you how to build a personal dev rel strategy. You can use this in at least three different ways:

1. To start building a body of work that you can take into an interview and talk intelligently about, including how you’ve measured success. I've also had brand new developer advocates tell me this method was super helpful for them getting started.
...
_If you want to go deeper in content strategy specifically, I highly recommend [Stephanie Morillo]’s book [The Developer’s Guide to Content Creation]. For more links and resources, check out [samjulien.com/devrel-book-links]._
